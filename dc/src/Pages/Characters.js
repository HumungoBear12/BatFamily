...
const Characters = () => {
    return(
      <div>
        <div className="memHeadBat">
          <h1 className="Members">The Bat-Family</h1>
        </div>
        <div className="Charhold">
          <div className="CharacterHolder1">
              ...
              <div className="Villains1">
                ...
                <ul>
                  <li className="BatVillains">The Joker </li>
                  <li className="BatVillains">ScareCrow</li>
                  <li className="BatVillains">Bane</li>
                  <li className="BatVillains">Posion Ivy</li>
                  <li className="BatVillains">Ra's Al Ghul</li>
                  <li className="BatVillains">The Riddler</li>
                </ul>
              </div>
              <div className="Measurments1">
                  <ul>
                    <h3 className="whowhowho">Information</h3>
                    <li className="CharacterMeasurement">Name: Bruce Wayne</li>
                    <li className="CharacterMeasurement">Age: 35 years Old</li>
                    <li className="CharacterMeasurement">Height: 6'2ft</li>
                    <li className="CharacterMeasurement">Weight: 210lbs</li>
                     <li className="CharacterMeasurement">First Appearance: Detective Comics #27</li>
              ...
              <div>
                <a href=""><button className="Btn-link"><h3 className="btn-Text">Character Page</h3></button></a>
              </div>
          </div>
          <div className="CharacterHolder2">
              ...
              <div className="Villains2">
                <p className="CharacterVillains">Villains</p>
                <ul>
                  <li className="BatVillains">DeathStroke</li>
                  <li className="BatVillains">Talon</li>
                  <li className="BatVillains">Paragon</li>
                  <li className="BatVillains">Tony Zucco</li>
                  <li className="BatVillains">Professor Pyg</li>
                  <li className="BatVillains">Trigon </li>
                </ul>
              </div>
              <div className="Measurments2">
                  <ul>
                    <h3 className="whowhowho">Information</h3>
                    <li className="CharacterMeasurement">Name:Dick Grayson</li>
                    <li className="CharacterMeasurement">Age: 21 </li>
                    <li className="CharacterMeasurement">Height: 5'10ft</li>
                    <li className="CharacterMeasurement">Weight: 175lbs </li>
                     <li className="CharacterMeasurement">First Appearance:Batman #408 </li>
                      <li className="CharacterMeasurement">Created by: Bob Kane,Bill Finger</li>
                  </ul>
              </div>
          ...
          <div className="CharacterHolder3">
              ...
              <div className="Villains3">
                <p className="CharacterVillains">Villains</p>
                <ul>
                  <li className="BatVillains">Black Mask</li>
                  <li className="BatVillains">Harley Quinn</li>
                  <li className="BatVillains">Mad Hatter</li>
                  <li className="BatVillains">Maxie Zeus</li>
                  <li className="BatVillains">DeathStroke</li>
                  <li className="BatVillains">Two Face</li>
                </ul>
              </div>
              <div className="Measurments3">
                  <ul>
                    <h3 className="whowhowho">Information</h3>
                    <li className="CharacterMeasurement">Name: Tim Drake</li>
                    <li className="CharacterMeasurement">Age: 17 years Old</li>
                    <li className="CharacterMeasurement">Height: 5'5ft</li>
                    <li className="CharacterMeasurement">Weight: 125lbs</li>
                     <li className="CharacterMeasurement">First Appearance: Batman #436</li>
                      <li className="CharacterMeasurement">Created by: Bob Kane,Bill Finger</li>
                  </ul>
              </div>
          ...
          <div className="CharacterHolder4">
              ...
              <div className="Villains4">
                ...
                <ul>
                  <li className="BatVillains">DeathStroke</li>
                  <li className="BatVillains">Jason Todd</li>
                  <li className="BatVillains">DeathStroke</li>
                  <li className="BatVillains">Mad Hatter</li>
                  <li className="BatVillains">Ra's Al Ghul</li>
                  <li className="BatVillains">Talia Al Ghul </li>
                </ul>
              </div>
              <div className="Measurments4">
                  <ul>
                    <h3 className="whowhowho">Information</h3>
                    <li className="CharacterMeasurement">Name:Damien Wayne</li>
                    <li className="CharacterMeasurement">Age: 14 </li>
                    <li className="CharacterMeasurement">Height: 5'4ft</li>
                    <li className="CharacterMeasurement">Weight: 120lbs </li>
                     <li className="CharacterMeasurement">First Appearance:Batman #666 </li>
                      <li className="CharacterMeasurement">Created by: Bob Kane,Bill Finger</li>
                  </ul>
              </div>
          ...
          <div className="CharacterHolder5">
              ...
              <div className="Villains5">
                ...
                <ul>
                  <li className="BatVillains">The Joker </li>
                  <li className="BatVillains">Penguin</li>
                  <li className="BatVillains">James Gordon Jr</li>
                  <li className="BatVillains">Mr Freeze</li>
                  <li className="BatVillains">Condiment King</li>
                  <li className="BatVillains">Harley Quinn</li>
                </ul>
              </div>
              <div className="Measurments5">
                  <ul>
                    <h3 className="whowhowho">Information</h3>
                    <li className="CharacterMeasurement">Name: Barbara Gordon</li>
                    <li className="CharacterMeasurement">Age: 24 years Old</li>
                    <li className="CharacterMeasurement">Height: 5'7ft</li>
                    <li className="CharacterMeasurement">Weight: 140lbs</li>
                     <li className="CharacterMeasurement">First Appearance: Detective Comics #359</li>
                      <li className="CharacterMeasurement">Created by: Bob Kane,Bill Finger</li>
                  </ul>
              </div>
          ...
          <div className="CharacterHolder6">
              ...
              <div className="Villains6">
                ...
                <ul>
                  <li className="BatVillains">The Joker</li>
                  <li className="BatVillains">Black Mask</li>
                  <li className="BatVillains">Nightwing</li>
                  <li className="BatVillains">Killer Kroc</li>
                  <li className="BatVillains">Professor Pyg</li>
                  <li className="BatVillains">Two Face</li>
                </ul>
              </div>
              <div className="Measurments6">
                  <ul>
                    <h3 className="whowhowho">Information</h3>
                    <li className="CharacterMeasurement">Name:Jason Todd</li>
                    <li className="CharacterMeasurement">Age: 20 </li>
                    <li className="CharacterMeasurement">Height: 6'2ft</li>
                    <li className="CharacterMeasurement">Weight: 240lbs </li>
                     <li className="CharacterMeasurement">First Appearance: Under the Hood</li>
                      <li className="CharacterMeasurement">Created by: Bob Kane,Bill Finger</li>
                  </ul>
              </div>
          ...
          <div className="CharacterHolder7">
              ...
              <div className="Villains7">
                ...
                <ul>
                  <li className="BatVillains">The Joker </li>
                  <li className="BatVillains">Bane</li>
                  <li className="BatVillains">Batman</li>
                  <li className="BatVillains">Batwoman</li>
                  <li className="BatVillains">Two Face</li>
                  <li className="BatVillains">Nightwing</li>
                </ul>
              </div>
              <div className="Measurments7">
                  <ul>
                    <h3 className="whowhowho">Information</h3>
                    <li className="CharacterMeasurement">Name: Selina Kyle</li>
                    <li className="CharacterMeasurement">Age: 23 years Old</li>
                    <li className="CharacterMeasurement">Height: 5'7ft</li>
                    <li className="CharacterMeasurement">Weight: 125lbs</li>
                     <li className="CharacterMeasurement">First Appearance: Batman #1</li>
                      <li className="CharacterMeasurement">Created by: Bob Kane,Bill Finger</li>
                  </ul>
              </div>
          ...
          <div className="CharacterHolder8">
              ...
              <div className="Villains8">
                <p className="CharacterVillains">Villains</p>
                <ul>
                  <li className="BatVillains">Lex Luthor</li>
                  <li className="BatVillains">DarkSeid</li>
                  <li className="BatVillains">Brainiac</li>
                  <li className="BatVillains">Doomsday</li>
                  <li className="BatVillains">Zod</li>
                  <li className="BatVillains">Toyman</li>
                </ul>
              </div>
              <div className="Measurments8">
                  <ul>
                    <h3 className="whowhowho">Information</h3>
                    <li className="CharacterMeasurement">Name:Clark Kent</li>
                    <li className="CharacterMeasurement">Age: 25 </li>
                    <li className="CharacterMeasurement">Height: 6'3ft</li>
                    <li className="CharacterMeasurement">Weight: 235lbs </li>
                     <li className="CharacterMeasurement">First Appearance: Superman #1</li>
          ...
          <div className="CharacterHolder9">
              ...
              <div className="Villains9">
                <p className="CharacterVillains">Villains</p>
                <ul>
                  <li className="BatVillains">None </li>
                  <li className="BatVillains">Because</li>
                  <li className="BatVillains">He</li>
                  <li className="BatVillains">is</li>
                  <li className="BatVillains">Alfred</li>
                  <li className="BatVillains">Pennyworth</li>
                </ul>
              </div>
              <div className="Measurments9">
                  <ul>
                    <h3 className="whowhowho">Information</h3>
                    <li className="CharacterMeasurement">Name: Alfred Pennyworth</li>
                    <li className="CharacterMeasurement">Age: 47 years Old</li>
                    <li className="CharacterMeasurement">Height: 6'0ft</li>
                    <li className="CharacterMeasurement">Weight: 170lbs</li>
                     <li className="CharacterMeasurement">First Appearance: Batman #16</li>
                      <li className="CharacterMeasurement">Created by: Bob Kane,Bill Finger</li>
                  </ul>
              </div>
          ...
          <div className="CharacterHolder10">
              ...
              <div className="Villains10">
                ...
                <ul>
                  ...
                  <li className="BatVillains">Scarecrow</li>
                  <li className="BatVillains">Two Face</li>
                  <li className="BatVillains">The Penguin</li>
                  <li className="BatVillains">Arkham Knight</li>
                </ul>
              </div>
              <div className="Measurments10">
                  <ul>
                    <h3 className="whowhowho">Information</h3>
                    <li className="CharacterMeasurement">Name:Jim Gordon</li>
                    <li className="CharacterMeasurement">Age: 51 </li>
                    <li className="CharacterMeasurement">Height: 6'2ft</li>
                    <li className="CharacterMeasurement">Weight: 275lbs </li>
                     <li className="CharacterMeasurement">First Appearance: Detective Comics #27</li>
                      <li className="CharacterMeasurement">Created by: Bob Kane,Bill Finger</li>
                  </ul>
              </div>
